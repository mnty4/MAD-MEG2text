...
if args.noise==True:
    print(args.noise)
    results_path = '/workspace/results/noise/'+state_dict.config.run_name
    mel_path = '/workspace/predmel_output/noise/'+state_dict.config.run_name

else:
    results_path = '/workspace/results/'+state_dict.config.run_name
    mel_path = '/workspace/predmel_output/'+state_dict.config.run_name
